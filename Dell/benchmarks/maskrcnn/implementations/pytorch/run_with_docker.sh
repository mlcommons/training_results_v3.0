...
_cont_mounts=("--volume=${DATADIR}:/data" "--volume=${DATADIR}/coco2017/coco_train2017_pyt:/coco_train2017_pyt"  "--volume=${LOGDIR}:/results" "--volume=${PKLPATH}:/pkl_coco")
...
docker exec -it "${_cont_name}" df -h -T 
