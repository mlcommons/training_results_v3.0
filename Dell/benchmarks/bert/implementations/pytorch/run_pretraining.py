...
def prepare_model_and_optimizer(args, device, stream):
    ...
    # mllogger.event(key=mllogger.constants.OPT_LAMB_EPSILON, value=optimizer.defaults['eps'], sync=False) #TODO 
...
#            assert use_DDP, "Running multi-GPU without --use_ddp"
        ...
        while global_step < args.max_steps and not end_training:
            ...
            if args.synthetic_input:
                ...
                train_data = pretraining_dataset(data_file, args.max_predictions_per_seq, args.max_seq_length, args.packed_samples, args.order_samples)
