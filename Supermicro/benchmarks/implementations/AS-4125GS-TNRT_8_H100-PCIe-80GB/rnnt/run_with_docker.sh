...
: "${CONT:?CONT not set}"
: "${DATADIR:=/home/smci/mlperf-training-v30/mlperf-train/rnnt/data/dataset}"
: "${METADATA_DIR:=/home/smci/mlperf-training-v30/mlperf-train/rnnt/data/metadata}"
: "${SENTENCEPIECES_DIR:=/home/smci/mlperf-training-v30/mlperf-train/rnnt/data/sentencepieces}"
...
: "${LOGDIR:=/home/smci/mlperf-training-v30/mlperf-train/rnnt/logs}"
