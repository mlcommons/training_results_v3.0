...
: "${LOGDIR:=/home/smci/mlperf-training-v30/mlperf-train/bert/logs}"
: "${MLPERF_MODEL_CONSTANT:=constants.BERT}"

: "${CONFIG_FILE:="./config_${DGXSYSTEM}.sh"}"
: "${_logfile_base:="${LOGDIR}/${DATESTAMP}"}"
: "${DGXNGPU:=8}"
: "${NV_GPU:="0,1,2,3,4,5,6,7"}"

: "${DATADIR_PHASE2:=/home/smci/mlperf-training-v30/mlperf-train/bert/data/packed_data}"
: "${CHECKPOINTDIR_PHASE1:=/home/smci/mlperf-training-v30/mlperf-train/bert/data/phase1}"
: "${EVALDIR:=/home/smci/mlperf-training-v30/mlperf-train/bert/data/hdf5/eval_varlength}"
