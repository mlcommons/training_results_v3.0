...
: "${CONT:?CONT not set}"
: "${PKLPATH:=/home/smci/mlperf-training-v30/mlperf-train/maskrcnn/data/coco2017/pickle_output/pkl_coco/bbox_only_instances_train2017.json.pickled}"
: "${PYTPATH:=/home/smci/mlperf-training-v30/mlperf-train/maskrcnn/data/coco2017/coco_train2017_pyt}"
: "${DATADIR:=/home/smci/mlperf-training-v30/mlperf-train/maskrcnn/data}"
...
: "${LOGDIR:=/home/smci/mlperf-training-v30/mlperf-train/maskrcnn/logs}"

# Other vars
readonly _config_file="./config_${DGXSYSTEM}.sh"
readonly _logfile_base="${LOGDIR}/${DATESTAMP}"
readonly _cont_name=object_detection
_cont_mounts=("--volume=${PWD}:/workspace/object_detection" "--volume=${DATADIR}:/data" "--volume=${LOGDIR}:/results" "--volume=${PKLPATH}:/pkl_coco" "--volume=${PYTPATH}:/coco_train2017_pyt")
