...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("multi_tensor_sgd_cuda", &at::native::syncfree::multi_tensor_sgd_cuda, "multi_tensor_sgd_cuda");
  m.def("step_optimizer_state_cuda", &at::native::syncfree::step_optimizer_state_cuda, "step_optimizer_state_cuda");
}
