...
class COCODatasetPYT:
    def __init__(
        self, base_file_name, img_dir, remove_images_without_annotations, global_transforms, transforms_properties, comm, master_rank, transforms=None, pkl_ann_file=None
    ):
