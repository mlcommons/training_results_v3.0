...
readonly _logfile_base="${LOGDIR}/${DATESTAMP}_${log_detail_tag}"
readonly _cont_name=object_detection
_cont_mounts=("--volume=${DATADIR}:/data" "--volume=${LOGDIR}:/results" "--volume=${PKLPATH}:/pkl_coco" "--volume=/home/mlperf/data/maskrcnn_new/coco2017/coco_train2017_pyt:/coco_train2017_pyt" "--volume=${PWD}:/workspace/object_detection")
