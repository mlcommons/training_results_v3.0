source $(dirname ${BASH_SOURCE[0]})/config_NF5468M6_common.sh
...
#for DALI eval
export DALI_EVAL_THREADS="6"
export DALI_EVAL_PREFETCH_QUEUE="5"
export DALI_EVAL_HW_DECODER_LOAD="0.99"
