hpu_ci_tests = [
    ...
    "unit/comm/test_dist.py::TestDistInit::test_no_init[True]",
    "unit/comm/test_dist.py::TestDistInit::test_already_init[True]",
    ...
    "unit/launcher/test_run.py::test_parser_local",
    ...
    "unit/elasticity/test_elastic.py::test_proper_mbsz",
    "unit/runtime/pipe/test_topology.py::test_topology_rank_repr",
    "unit/runtime/pipe/test_topology.py::test_topology_2d",
    "unit/runtime/pipe/test_topology.py::test_primes",
    "unit/runtime/sparse_tensor/test_csr.py::test_csr_addition_different",
    "unit/compression/test_compression.py::TestCompression::test_linear_layer_compress",
...
hpu_promote_tests = [
    ...
    "unit/launcher/test_run.py::test_parser_errors",
    "unit/launcher/test_run.py::test_num_plus_parser",
    ...
    "unit/runtime/test_pld.py::test_pld_schedule[0]",
    "unit/runtime/test_pld.py::test_pld_schedule[0.9]",
    "unit/runtime/test_pld.py::test_pld_schedule[1.0]",
    "unit/runtime/test_pld.py::test_pld_schedule[0.1]",
