...
PARSER.add_argument('--hmp-bf16', default=os.path.join(os.path.dirname(os.path.abspath(__file__)),
                    '../ops_bf16.txt'), help='Path to bf16 ops list in hmp O1 mode')
PARSER.add_argument('--hmp-fp32', default=os.path.join(os.path.dirname(os.path.abspath(__file__)),
                    '../ops_fp32.txt'), help='Path to fp32 ops list in hmp O1 mode')
